...
export const BlogModel = {
  ...
  getAll: async (page = BLOGS_PER_PAGE, limit = 6, userId = null) => {
    ...
    const result = await pool.query(blogsQuery, [limit, offset, userId || null]);
  ...
  getByUserId: async (userId, page = 1, limit = 6) => {
    const offset = (page - 1) * limit;
